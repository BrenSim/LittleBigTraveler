...
namespace LittleBigTraveler.Models.DataBase
{
    public interface IAllInclusiveTravelDAL : IDisposable
    {
        ...
        int CreateAllInclusiveTravel(int customerId, int travelId, string name, string description);
        void DeleteAllInclusiveTravel(int id);
        void ModifyAllInclusiveTravel(int id, string name, string description);
